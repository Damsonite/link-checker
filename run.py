...
def link_check(*cli: str) -> int:
    return subprocess.run(
        [sys.executable, str(LINK_CHECK), *cli, "--no-color"]
    ).returncode
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_ping = sub.add_parser("ping", help="Hace ping al otro extremo y muestra diagnóstico.")
